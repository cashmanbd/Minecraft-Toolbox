...
class Level {
    ...
    void save(final String saveFolder) {
        ...
        dataTag.putBoolean("initialized", true);
        ...
        dataTag.putBoolean("MapFeatures", false); // (true/false) - true if the map generator should place structures such as villages, strongholds, and mineshafts. Defaults to 1. Always 1 if the world type is Customized.
        dataTag.putLong("LastPlayed", System.currentTimeMillis()); // The Unix time when the level was last loaded.
        dataTag.putLong("SizeOnDisk", 100); //TODO The estimated size in bytes of the level. Currently not modified or used by Minecraft, but was previously.
        ...
        dataTag.putByte("Difficulty", (byte)1); // The current difficulty setting. 0 is Peaceful, 1 is Easy, 2 is Normal, and 3 is Hard. Defaults to 2.
        dataTag.putByte("DifficultyLocked", (byte)0); // 1 or 0 (true/false) - True if the difficulty has been locked. Defaults to 0.
        ...
        dataTag.putByte("raining", (byte)0); // 1 or 0 (true/false) - true if the level is currently experiencing rain, snow, and cloud cover.
        ...
        dataTag.putBoolean("thundering", false); // 1 or 0 (true/false) - true if the rain/snow/cloud cover is a lightning storm and dark enough for mobs to spawn under the sky.
